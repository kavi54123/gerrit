...
class PerPersonJsonFormatter implements CommitDataProcessor.OutputFormatter<PerPersonData> {
    ...
    private static class IdentityRecordOverviewSerializer implements JsonSerializer<IdentityRecord> {
        ...
        public JsonElement serialize(IdentityRecord identityRecord,
            ...
            json.add("positiveReviewCount", context.serialize(identityRecord.getPositiveReviewCount()));
            ...
            json.add("negativeReviewCount", context.serialize(identityRecord.getNegativeReviewCount()));
            ...
            json.add("inReviewCommitCount", context.serialize(identityRecord.getInReviewCommitCount()));
            json.add("mergedCommitCount", context.serialize(identityRecord.getMergedCommitCount()));
        ...
        public <T> TypeAdapter<T> create(final Gson gson, TypeToken<T> type) {
            ...
            return new TypeAdapter<T>() {
                ...
                public void write(JsonWriter writer, T value) throws IOException {
                    ...
                    object.add("mergedCommitCount", new JsonPrimitive(record.getMergedCommitCount()));
